...
public class MovimientoController {
    ...
    public ResponseEntity<GenericResponse<List<MovimientoResDTO>>> findAll() {
        List<MovimientoResDTO> movimientos = movimientosService.findAll()
    ...
    public ResponseEntity<GenericResponse<MovimientoResDTO>> saveMovimiento(
        ...
        Movimiento nuevoMovimiento = movimientosService.saveMovimiento(
                movimientosMapper.movimientoReqDTOToMovimiento(movimiento)
        );
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(GenericResponse.<MovimientoResDTO>builder()
                        ...
                        .payload(movimientosMapper.movimientoToMovimientoResDTO(nuevoMovimiento))
                        .build()
                );
    }
}
